        ...
        <>
            ...
            <div className={`detalhePokemon`}>
                <Link href={pokemon.name}>
                    ...
                    <p><Image className="pokemon" src={`https://www.pokemon.com/static-assets/content-assets/cms2/img/pokedex/full/${numero}.png`} width={150} height={150} alt="XXX"></Image></p>
