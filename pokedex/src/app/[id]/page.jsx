                        ...
                        <div className="stats-container">
                            ...
                            <div className="stats">
                                <div className="stat-row">
                                    ...
                                    <meter id="hp" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.hp / 255).toString()} className="stat-meter" />
                                </div>
                                <div className="stat-row">
                                    <label htmlFor="atk" className="stat-label">Attack: {pokemon?.baseStats?.atk}</label>
                                    <meter id="atk" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.atk / 255).toString()} className="stat-meter" />
                                </div>
                                <div className="stat-row">
                                    <label htmlFor="def" className="stat-label">Defense: {pokemon?.baseStats?.def}</label>
                                    <meter id="def" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.def / 255).toString()} className="stat-meter" />
                                </div>
                                <div className="stat-row">
                                    <label htmlFor="spa" className="stat-label">Special Attack: {pokemon?.baseStats?.spa}</label>
                                    <meter id="spa" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.spa / 255).toString()} className="stat-meter" />
                                </div>
                                <div className="stat-row">
                                    <label htmlFor="spd" className="stat-label">Special Defense: {pokemon?.baseStats?.spd}</label>
                                    <meter id="spd" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.spd / 255).toString()} className="stat-meter" />
                                </div>
                                <div className="stat-row">
                                    <label htmlFor="spe" className="stat-label">Speed: {pokemon?.baseStats?.spe}</label>
                                    <meter id="spe" min={0} max={1} low={0.2} high={0.5} optimum={1} value={(pokemon?.baseStats?.spe / 255).toString()} className="stat-meter" />
                                </div>
                            </div>
                        </div>
